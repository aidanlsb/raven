...
Object-field and trait `.value` date/datetime comparisons share one SQL helper.
Values that look like dates or datetimes but fail to parse must fail the query;
