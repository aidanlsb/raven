...
### Changed
- Bumped the Go toolchain from 1.25.13 to 1.26.1 and refreshed module dependencies (including goldmark, golang.org/x/sys, and modernc.org/sqlite), covering standard-library fixes that govulncheck reports against go1.26.0.
