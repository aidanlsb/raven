...
- `rvn check` now reports `markdown_link_to_vault_note` when Markdown link/image syntax targets an in-vault `.md` note that must use a wikilink to participate in the reference graph.
