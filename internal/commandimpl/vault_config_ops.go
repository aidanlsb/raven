...
// HandleVaultConfigAutoReindexSet executes the canonical `vault_config_auto_reindex_set` command.
func HandleVaultConfigAutoReindexSet(ctx context.Context, req commandexec.Request) commandexec.Result {
	return handleVaultConfigOperation(ctx, req, "vault_config_auto_reindex_set")
}

// HandleVaultConfigAutoReindexUnset executes the canonical `vault_config_auto_reindex_unset` command.
func HandleVaultConfigAutoReindexUnset(ctx context.Context, req commandexec.Request) commandexec.Result {
	return handleVaultConfigOperation(ctx, req, "vault_config_auto_reindex_unset")
}

// HandleVaultConfigProtectedPrefixesList executes the canonical `vault_config_protected_prefixes_list` command.
func HandleVaultConfigProtectedPrefixesList(ctx context.Context, req commandexec.Request) commandexec.Result {
	return handleVaultConfigOperation(ctx, req, "vault_config_protected_prefixes_list")
}

// HandleVaultConfigProtectedPrefixesAdd executes the canonical `vault_config_protected_prefixes_add` command.
func HandleVaultConfigProtectedPrefixesAdd(ctx context.Context, req commandexec.Request) commandexec.Result {
	return handleVaultConfigOperation(ctx, req, "vault_config_protected_prefixes_add")
}

// HandleVaultConfigProtectedPrefixesRemove executes the canonical `vault_config_protected_prefixes_remove` command.
func HandleVaultConfigProtectedPrefixesRemove(ctx context.Context, req commandexec.Request) commandexec.Result {
	return handleVaultConfigOperation(ctx, req, "vault_config_protected_prefixes_remove")
}

// HandleVaultConfigExcludeList executes the canonical `vault_config_exclude_list` command.
func HandleVaultConfigExcludeList(ctx context.Context, req commandexec.Request) commandexec.Result {
	return handleVaultConfigOperation(ctx, req, "vault_config_exclude_list")
}

// HandleVaultConfigExcludeAdd executes the canonical `vault_config_exclude_add` command.
func HandleVaultConfigExcludeAdd(ctx context.Context, req commandexec.Request) commandexec.Result {
	return handleVaultConfigOperation(ctx, req, "vault_config_exclude_add")
}

// HandleVaultConfigExcludeRemove executes the canonical `vault_config_exclude_remove` command.
func HandleVaultConfigExcludeRemove(ctx context.Context, req commandexec.Request) commandexec.Result {
	return handleVaultConfigOperation(ctx, req, "vault_config_exclude_remove")
}

// HandleVaultConfigDirectoriesGet executes the canonical `vault_config_directories_get` command.
func HandleVaultConfigDirectoriesGet(ctx context.Context, req commandexec.Request) commandexec.Result {
	return handleVaultConfigOperation(ctx, req, "vault_config_directories_get")
}

// HandleVaultConfigDirectoriesSet executes the canonical `vault_config_directories_set` command.
func HandleVaultConfigDirectoriesSet(ctx context.Context, req commandexec.Request) commandexec.Result {
	return handleVaultConfigOperation(ctx, req, "vault_config_directories_set")
}

// HandleVaultConfigDirectoriesUnset executes the canonical `vault_config_directories_unset` command.
func HandleVaultConfigDirectoriesUnset(ctx context.Context, req commandexec.Request) commandexec.Result {
	return handleVaultConfigOperation(ctx, req, "vault_config_directories_unset")
}

// HandleVaultConfigCaptureGet executes the canonical `vault_config_capture_get` command.
func HandleVaultConfigCaptureGet(ctx context.Context, req commandexec.Request) commandexec.Result {
	return handleVaultConfigOperation(ctx, req, "vault_config_capture_get")
}

// HandleVaultConfigCaptureSet executes the canonical `vault_config_capture_set` command.
func HandleVaultConfigCaptureSet(ctx context.Context, req commandexec.Request) commandexec.Result {
	return handleVaultConfigOperation(ctx, req, "vault_config_capture_set")
}

// HandleVaultConfigCaptureUnset executes the canonical `vault_config_capture_unset` command.
func HandleVaultConfigCaptureUnset(ctx context.Context, req commandexec.Request) commandexec.Result {
	return handleVaultConfigOperation(ctx, req, "vault_config_capture_unset")
}

// HandleVaultConfigDeletionGet executes the canonical `vault_config_deletion_get` command.
func HandleVaultConfigDeletionGet(ctx context.Context, req commandexec.Request) commandexec.Result {
	return handleVaultConfigOperation(ctx, req, "vault_config_deletion_get")
}

// HandleVaultConfigDeletionSet executes the canonical `vault_config_deletion_set` command.
func HandleVaultConfigDeletionSet(ctx context.Context, req commandexec.Request) commandexec.Result {
	return handleVaultConfigOperation(ctx, req, "vault_config_deletion_set")
}

// HandleVaultConfigDeletionUnset executes the canonical `vault_config_deletion_unset` command.
func HandleVaultConfigDeletionUnset(ctx context.Context, req commandexec.Request) commandexec.Result {
	return handleVaultConfigOperation(ctx, req, "vault_config_deletion_unset")
}
