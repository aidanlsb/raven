...
func RegisterAll(registry *commandexec.HandlerRegistry) {
	...
	registry.Register("vault_config_assets_show", HandleVaultConfigAssetsShow)
	registry.Register("vault_config_assets_set", HandleVaultConfigAssetsSet)
	registry.Register("vault_config_assets_kind_set", HandleVaultConfigAssetsKindSet)
