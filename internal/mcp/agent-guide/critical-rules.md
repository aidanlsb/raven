...
**⚠️ NEVER use shell commands for file operations in a Raven keep.**
...
| Read keep files | `raven_read` | `cat`, `head`, `tail` |
| Edit content | `raven_edit` | `sed`, `awk`, `vim` |
| Update frontmatter | `raven_set` | Manual file edits |

**Why this is critical:**
- `raven_move` automatically updates ALL references to the moved file across the keep
