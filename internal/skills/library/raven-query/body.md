...
- `rvn query`: returns schema-aware object rows or real trait rows. Use when you know the type, field names, or trait names. Supports predicates, pagination, bulk apply.
